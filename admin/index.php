  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="#"><i class="fa-solid fa-clock-rotate-left"></i> История <span class="sr-only">(current)</span></a>
        </li>
      </ul>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo("<tr><th scope='row'>".$row["id"]."</th> <td>".$row["name"]."</td><td><span class='badge badge-success'>".$row["status"]."</span></td><td><a href='remove_machine.php?id=".$row["id"]."' class='btn btn-danger'><i class='fa-solid fa-trash-can'></i></a></td></tr>");
  }
} else {
  echo "0 results";
}
